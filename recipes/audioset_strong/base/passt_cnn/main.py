...
from recipes.audioset_strong.base.passt_cnn.train import Trainer
from src.models.passt.passt_cnn import PaSST_CNN
...
if __name__ == "__main__":
    ...
    optimizer, scheduler = optimizer_and_scheduler_setting(net, total_lr, train_loader, configs, my_logger.logger)
