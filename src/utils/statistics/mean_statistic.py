...
class ProbMeanValue:
    ...
    def __init__(self, n_bins) -> None:
        ...
        self.hist_strong_pos = {i: np.zeros(n_bins) for i in range(10)}
        self.hist_strong_neg = {i: np.zeros(n_bins) for i in range(10)}
        self.hist_weak_pos = {i: np.zeros(n_bins) for i in range(10)}
        self.hist_weak_neg = {i: np.zeros(n_bins) for i in range(10)}
