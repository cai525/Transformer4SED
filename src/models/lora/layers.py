...
class Embedding(nn.Embedding, LoRALayer):
    ...
    def __init__(self,
                 ...
                 requires_grad_pretrain: bool = False,
                 **kwargs):
        ...
        if r > 0:
            ...
            self.weight.requires_grad = requires_grad_pretrain
...
class MergedLinear(nn.Linear, LoRALayer):
    ...
    def __init__(self,
        ...
        if r > 0 and any(enable_lora):
            ...
            self.lora_B = nn.Parameter(self.weight.new_zeros((out_features // len(enable_lora) * sum(enable_lora),
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if r > 0:
            ...
            self.scaling = self.lora_alpha / self.r
            # Freezing the pre-trained weight matrix
            self.conv.weight.requires_grad = requires_grad_pretrain
        self.reset_parameters()
        self.merged = False
