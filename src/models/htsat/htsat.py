...
from src.models.htsat.utils import do_mixup, interpolate
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=dim,
                                 ...
                                 norm_before_mlp=norm_before_mlp) for i in range(depth)
        ])
...
class HTSAT_Swin_Transformer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # stochastic depth
        dpr = [x.item()
               for x in torch.linspace(0, self.drop_path_rate, sum(self.depths))]  # stochastic depth decay rule
    ...
    def forward_features(self, x, longer_idx=None):
        ...
        # get latent_output
        fine_grained_latent_output = torch.mean(x, dim=2).transpose(1, 2)
    ...
    def wav2mel(self, x, mixup_lambda):
